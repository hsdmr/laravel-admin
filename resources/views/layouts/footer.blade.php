    ...
    <div class="container py-4" style="color: white;">
        <div class="row">
            <div class="col-md-3 " style="color: white;">
                @isset($widget[0]->title)<h4 style="color:white; font-weight:bolder;">{{ $widget[0]->title }}</h4>
                @endisset
                        ...
                        <ul>
                            @foreach (App\Models\Menu::orderBy('order', 'asc')->where('menuname', '=', $widget[0]->menu)->get() as $menuItem)
                                @if ($menuItem->parent == null && $menuItem->title != null)
                                    <li><a
                                            href="{{ $menuItem->children->isEmpty() ? url('/', $menuItem->link) : '#' }}">{{ $menuItem->title }}</a>
                                    </li>
                                @endif
                ...
                <div class="col-md-3 " style="color: white;">
                    @isset($widget[1]->title)<h4 style="color:white; font-weight:bolder;">{{ $widget[1]->title }}</h4>
                    @endisset
                    ...
                    <div class="col-md-3 " style="color: white;">
                        @isset($widget[2]->title)<h4 style="color:white; font-weight:bolder;">{{ $widget[2]->title }}</h4>
                        @endisset
                            ...
                            @isset($widget[2]->menu)
                                <ul>
                                    @foreach (App\Models\Menu::orderBy('order', 'asc')->where('menuname', '=', $widget[2]->menu)->get() as $menuItem)
                                        ...
                                        @if (!$menuItem->children->isEmpty())
                                            @foreach ($menuItem->children as $subMenuItem)
                                                <li><a href="{{ url('/', $subMenuItem->link) }}">- {{ $subMenuItem->title }}</a>
                                                </li>
                                            @endforeach
                                        @endif
                                    @endforeach
                        ...
                        <div class="col-md-3 " style="color: white;">
                            @isset($widget[3]->title)<h4 style="color:white; font-weight:bolder;">{{ $widget[3]->title }}</h4>
                            @endisset
