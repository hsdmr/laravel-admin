  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-dark">{{ __('İletişim Bilgileri') }}</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{ __('İletişim Bilgileri') }}</li>
            </ol>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
                        ...
                        <form action="{{ route('admin.setting.contactUpdate',1) }}" method="post" id="form" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="zoom" class="col-md-1">Zoom</label>
