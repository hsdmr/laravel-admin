                        ...
                        <tbody>
                            @foreach ($comments as $comment)
                                <tr>
                                    ...
                                    <td><input class="switch" type="checkbox" name="my-checkbox" data-id="{{$comment->id}}" @if ($comment->status==1) checked @endif data-toggle="toggle" data-size="mini" data-on="{{__('main.Published')}}" data-off="{{__('main.Draft')}}" data-onstyle="success" data-offstyle="danger"></td>
                                    <td>
...
$('.switch').change(function(){
    ...
    $.get("{{route('admin.comment.switch')}}", {id:id,status:status})
})
</script>
@endsection
