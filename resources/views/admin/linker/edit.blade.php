                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control form-control-sm col-md-9 @error('word') is-invalid @enderror" id="word" name="word" value="{{old('word') ?? $link->word}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control form-control-sm col-md-9 @error('url') is-invalid @enderror" id="url" name="url" value="{{old('url') ?? $link->url}}">
